...
mysqli_query($conn,"create database Scores");
mysqli_select_db($conn,"Scores");
mysqli_query($conn,"SELECT MAX() FROM mytable)");
$last_id = mysqli_insert_id($conn)
"UPDATE  SET lastname='$total' WHERE id=2";
mysqli_query($conn,"insert into scoreuser values('$m','$total')");
*/
Echo "<a href=pay.html>Click Here To Proceed</a>";
}
else
Echo "<a href=generalquiz.html>You need to retake the test</a>";
