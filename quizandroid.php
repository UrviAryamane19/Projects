...
echo "<div id = 'results'>$total / 20</div>";
echo "Click Here To<a href = 'course.html'> read chapter again and Give Test</a><br/>";
echo "Click Here to go to<a href ='main_content.html'> Account Page</a><br/>";
echo "Thank you for giving Test";
